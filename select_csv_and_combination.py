...
def plot_portfolio_result(pot_file_name):
    ...
    plt.close()
    png_file_name = "%s%s" % (pot_file_name, ".png")
    return ind_1, ind_2, ind_3, ind_4, ind_5, png_file_name
...
def test_unit0(dir_name, table, message):
    ...
    print len(raw_value)
    print raw_value
    call_it(dir_name, real_values, message, 'you')
...
def call_it(dir_name, table_array, stand_name):
    ...
    val = plot_portfolio_result(name)
    # print 'Success!'
    return name, val
